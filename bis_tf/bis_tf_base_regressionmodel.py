...
class BaseRegressionModel(basemodel.BaseModel):
    ...
    def __init__(self):
        super().__init__()
        self.params['name']='BaseRegressionModel';
    ...
    def get_description(self):
        return "Base Regression Model. Can be used to reconstruct."
    ...
    def initialize(self,input_data,patch_shape,max_outputs=3):
        ...
        final_target_patch_shape=self.calcparams['patch_size']
