...
def create_model(input_data, 
    ...
    with tf.variable_scope(name) as scope:
        ...
        pad_values=[[0,0],[num_convs_per_layer,num_convs_per_layer],[num_convs_per_layer,num_convs_per_layer],[num_convs_per_layer,num_convs_per_layer],[0,0]]
...
def create_output_dictionary(model_output,
    ...
    with tf.variable_scope(scope_name):
        if num_classes>1:
            ...
            dim=len(model_output.get_shape())-1
            print("JAO: model_output.shape="+str(model_output.get_shape()))
            print("JAO: dim="+str(dim))
...
class UNet3DModel(bisbasesegmentationmodel.BaseSegmentationModel):
    ...
    def get_description(self):
        return "U-Net Model for 3D images."
